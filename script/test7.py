...
# ============================================================
# 가상 자(virtual ruler) 생성: 바닥 위에 길이 L인 박스 생성
# ============================================================
def add_virtual_ruler(scene: trimesh.Scene,
    ...
    try:
        ...
        # 방향 정렬용 회전 행렬 구성 (local x -> direction)
        x_axis = direction
    ...
    def _render_snapshot_and_set_camera(self):
        ...
        try:
            ...
            if self.ruler_world_p1 is not None and self.ruler_world_p2 is not None:
                ...
                # 라인
                self.canvas.create_line(px1, py1, px2, py2, fill="yellow", width=4)
